                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <div class="clearfix">
                                <div class="btn-group">
                                    <a href="#modalNoticias" data-toggle="modal">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="frmEditarExterna" role="form" action="noticia_update.php"
                                                    ...
                                                    <input type="hidden" name="tipo_de_requisicao" value="alterar"/>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="frmEditarInterna" role="form" action="FuncoesNoticias.php"
                                                    ...
                                                    <div class="form-group">
                                                        <label>Texto:</label>
                                                        <textarea required="true" id="texto" class="form-control"
                                                                  name="texto"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Exibir post</label>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" style="background-color: #f1f2f7;">
                                                ...
                                                <form id="frmAlterarImg" class="form-horizontal"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label">Tamanho da imagem
                                                            (%):</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label">Distância do topo:</label>
                                                        ...
                                                        <input type="hidden" name="tipo_de_requisicao"
                                                               value="alterarImg"/>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div id="modal-body-interna" class="modal-body" style="padding: 40px">
                                                <center><h3 id="tituloNoticiaInterna"></h3><br>
                                                    <img id="imgNoticiaInterna" class="img-responsive"
                                                         style="width: 80%;"/><br>
...
<script src="include/toatrNoticias.js" type="text/javascript"></script>

<?php
if (isset($_SESSION['message'])) {
    switch ($_SESSION['message']) {
        case "updateSucesso":
            echo "<script>msgSucesso('Notícia atualizada com sucesso.','Sucesso')</script>";
            break;
        case "updateErro":
            echo "<script>msgErro('Houve um erro ao atualizar a notícia.','Erro')</script>";
            break;
        case "deleteSucesso":
            echo "<script>msgSucesso('Notícia excluída com sucesso.','Sucesso')</script>";
            break;
        case "deleteErro":
            echo "<script>msgErro('Houve um erro ao excluir a notícia.','Erro')</script>";
            break;
        case "cadastroSucesso":
            echo "<script>msgSucesso('Notícia cadastrada com sucesso.','Sucesso')</script>";
            break;
        case "cadastroErro":
            echo "<script>msgErro('Houve um erro ao inserir a notícia.','Erro')</script>";
            break;
    }
